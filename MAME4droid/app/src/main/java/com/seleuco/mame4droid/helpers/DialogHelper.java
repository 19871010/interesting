    ...
    public Dialog createDialog(int id) {
        ...
        switch (id) {
            ...
            case DIALOG_ROMs_DIR:
                ...
                builder.setMessage(R.string.Path_Confirm_ROMs)
                        .setCancelable(false)
                        .setPositiveButton(R.string.Yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                DialogHelper.savedDialog = DIALOG_NONE;
            ...
            case DIALOG_EXIT:
                ...
                builder.setMessage(R.string.Exit_Confirm_App)
                        .setCancelable(false)
                        .setPositiveButton(R.string.Yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                //System.exit(0);
            ...
            case DIALOG_EXIT_GAME:
                builder.setMessage(R.string.Exit_Confirm_Game)
                        .setCancelable(false)
                        .setPositiveButton(R.string.Yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                DialogHelper.savedDialog = DIALOG_NONE;
            ...
            case DIALOG_FULLSCREEN:
                ...
                final CharSequence[] items1 = {"载入进度", "保存进度", "帮助", "设置", "联机" /*"Support",*/};
                final CharSequence[] items2 = {"帮助", "设置", "联机"/*"Support"*/};
                final CharSequence[] items3 = {"退出", "载入进度", "保存进度", "帮助", "设置", "联机"/*"Support",*/};
                final CharSequence[] items4 = {"退出", "帮助", "设置", "联机" /*"Support"*/};
