...
class NVMouseExtensionException extends RuntimeException {
    ...
    public NVMouseExtensionException(int err) {
        ...
        switch (err) {
            case (Wrap_NVMouseExtensions.ERR_NVMOUSEEXT_NOMETHOD): {
                strError = "setCursorVisibility method doesn't exist";
                break;
            }
            case (Wrap_NVMouseExtensions.ERR_NVMOUSEEXT_ACCESSEX_X): {
                strError = "AXIS_RELATIVE_X not accessable";
                break;
            }
            case (Wrap_NVMouseExtensions.ERR_NVMOUSEEXT_ACCESSEX_Y): {
                strError = "AXIS_RELATIVE_Y not accessable";
                break;
            }
            case (Wrap_NVMouseExtensions.ERR_NVMOUSEEXT_NOFIELD_X): {
                strError = "AXIS_RELATIVE_X field doesn't exist";
                break;
            }
            case (Wrap_NVMouseExtensions.ERR_NVMOUSEEXT_NOFIELD_Y): {
                strError = "AXIS_RELATIVE_Y field doesn't exist";
                break;
            }
        }
...
class Wrap_NVMouseExtensions {
    ...
    static {
        try {
            ...
            throw new NVMouseExtensionException(ERR_NVMOUSEEXT_NOMETHOD);
        }
        ...
        try {
            ...
            try {
                ...
                throw new NVMouseExtensionException(ERR_NVMOUSEEXT_ACCESSEX_X);
            }
        } catch (NoSuchFieldException ex) {
            throw new NVMouseExtensionException(ERR_NVMOUSEEXT_NOFIELD_X);
        }
        ...
        try {
            ...
            try {
                ...
                throw new NVMouseExtensionException(ERR_NVMOUSEEXT_ACCESSEX_Y);
            }
        } catch (NoSuchFieldException ex) {
            throw new NVMouseExtensionException(ERR_NVMOUSEEXT_NOFIELD_Y);
        }
    }
